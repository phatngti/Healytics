...
export const bussinessServices = new Map<
  BusinessType,
  { label: string; value: BusinessType; description: string }
>([
  [
  ...
  [
    BusinessType.MASSAGE_REHABILITATION,
    {
      ...
      value: BusinessType.MASSAGE_REHABILITATION,
  ...
  [
    BusinessType.DENTAL,
    { label: 'Dental', value: BusinessType.DENTAL, description: 'Nha khoa' },
  ],
  [
    BusinessType.TRADITIONAL_MEDICINE,
    {
      label: 'Traditional Medicine',
      value: BusinessType.TRADITIONAL_MEDICINE,
      description: 'Đông y',
    },
  ],
  [
    BusinessType.PSYCHOLOGY,
    {
      ...
      value: BusinessType.PSYCHOLOGY,
      description: 'Tâm lý & Trị liệu',
    },
  ],
  [
    BusinessType.DERMATOLOGY,
    {
      ...
      value: BusinessType.DERMATOLOGY,
  ...
  [
    ...
    {
      label: 'Psychiatry',
      value: BusinessType.PSYCHIATRY,
      description: 'Tâm thần học',
    },
  ],
]);
