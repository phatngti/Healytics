...
export class RegisterProfileDto {
  ...
  @ApiPropertyOptional({ example: 'Patient is healthy', description: 'Short bio or notes', type: String })
  @IsOptional()
  @IsString()
  bio?: string;

  @ApiPropertyOptional({ example: '1990-01-01', description: 'Date of birth in ISO format' })
  @IsOptional()
  @IsDateString()
  dateOfBirth?: string;
}
