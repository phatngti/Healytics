...
export class CreateTherapistProfileDto {
  ...
  @ApiPropertyOptional({
    ...
    description: 'Therapist strength level',
  })
...
export class CreateEmployeeDto {
  ...
  @ApiPropertyOptional({
    ...
    description: 'Therapist profile data if role is THERAPIST',
  })
  @IsOptional()
  @ValidateNested()
  @Type(() => CreateTherapistProfileDto)
