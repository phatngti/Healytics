...
export class PublicProductRecommendedResponseDto {
  ...
  static fromEntity(product: Product): PublicProductRecommendedResponseDto {
    const dto = new PublicProductRecommendedResponseDto();
  ...
  static fromEntities(products: Product[]): PublicProductRecommendedResponseDto[] {
    return products.map((p) => PublicProductRecommendedResponseDto.fromEntity(p));
  }
}
