...
export class PublicProductInfoResponseDto {
  ...
  static fromEntity(product: Product, partner?: Partner | null): PublicProductInfoResponseDto {
    const dto = new PublicProductInfoResponseDto();
