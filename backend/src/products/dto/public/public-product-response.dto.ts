...
export class PublicProductResponseDto {
  ...
  @ApiPropertyOptional({ type: PublicCategorySummaryDto, description: 'Product category' })
  category: PublicCategorySummaryDto | null;

  @Expose()
  @Type(() => PublicProductMediaDto)
  @ApiPropertyOptional({ type: [PublicProductMediaDto], description: 'Product media assets' })
  media: PublicProductMediaDto[];

  @Expose()
  @Type(() => PublicProductDefinitionDto)
  @ApiPropertyOptional({ type: PublicProductDefinitionDto, description: 'Product definition for service products' })
  productDefinition: PublicProductDefinitionDto | null;

  @Expose()
  @Type(() => PublicProductEmployeeEligibilityDto)
  @ApiPropertyOptional({ type: [PublicProductEmployeeEligibilityDto], description: 'Eligible employees for service' })
  productEmployeeEligibilities: PublicProductEmployeeEligibilityDto[];
}
