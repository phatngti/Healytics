...
export class PartnerProductDetailResponseDto {
  @ApiProperty() id: string;
  @ApiProperty() title: string;
   ...
   */
  static fromEntity(product: Product, recommended: Product[]): PartnerProductDetailResponseDto {
    const dto = new PartnerProductDetailResponseDto();
