...
/**
 * Response DTO for product definition within product.
 ...
 */
export class PartnerProductResponseDto {
  @Expose()
  ...
  @ApiPropertyOptional({ type: PartnerCategorySummaryDto, description: 'Product category' })
  category: PartnerCategorySummaryDto | null;

  @Expose()
  @Type(() => PartnerProductMediaDto)
  @ApiPropertyOptional({ type: [PartnerProductMediaDto], description: 'Product media assets' })
  media: PartnerProductMediaDto[];

  @Expose()
  @Type(() => PartnerProductDefinitionDto)
  @ApiPropertyOptional({ type: PartnerProductDefinitionDto, description: 'Product definition for service products' })
  productDefinition: PartnerProductDefinitionDto | null;

  @Expose()
  @Type(() => PartnerProductEmployeeEligibilityDto)
  @ApiPropertyOptional({ type: [PartnerProductEmployeeEligibilityDto], description: 'Eligible employees for service' })
  productEmployeeEligibilities: PartnerProductEmployeeEligibilityDto[];
}
