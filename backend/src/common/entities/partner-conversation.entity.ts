 ...
 */
@Entity('partner_conversations')
@Unique('UQ_PARTNER_CONV_USER_PARTNER', ['userId', 'partnerAccountId'])
export class PartnerConversation {
  ...
  @OneToMany(() => PartnerChatMessage, (m) => m.conversation)
