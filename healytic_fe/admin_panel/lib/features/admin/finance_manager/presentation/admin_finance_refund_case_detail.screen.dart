...
class AdminFinanceRefundCaseDetailScreen
    extends ConsumerWidget {
  const AdminFinanceRefundCaseDetailScreen({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final async = ref.watch(
      adminFinanceRefundCaseDetailProvider(id),
    );
        ...
        child: Column(
          ...
          children: [
            ...
            if (detail.decisionNote.isNotEmpty) ...[
              AppDimens.verticalMedium,
              _info(context, 'Decision', {
                'Note': detail.decisionNote,
              }),
            ],
            AppDimens.verticalMedium,
