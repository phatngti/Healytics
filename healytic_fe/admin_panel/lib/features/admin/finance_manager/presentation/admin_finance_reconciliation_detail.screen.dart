...
class AdminFinanceReconciliationDetailScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final async = ref.watch(adminFinanceReconciliationDetailProvider(id));
          ...
          children: [
            Row(
              children: [
                ...
                AdminFinanceStatusChip(label: e.status.label),
              ],
            ),
                ...
                FilledButton.icon(
                  ...
                  onPressed: () async {
                    final note = await showAdminFinanceActionDialog(
                      ...
                      description: 'Resolve this reconciliation exception.',
                    ...
                    if (note != null && context.mounted) {
                      await ref
                          ...
                          .resolveReconciliation(e.id, note: note);
                      ref
                ...
                OutlinedButton.icon(
                  ...
                  onPressed: () async {
                    final note = await showAdminFinanceActionDialog(
                      ...
                      description: 'Reopen this reconciliation exception.',
                      confirmLabel: 'Reopen',
                    );
                    if (note != null && context.mounted) {
                      await ref
            ...
            _info(context, 'Exception Summary', {
              ...
              'Related Txn': e.relatedTransactionId?.value ?? '—',
              'Expected': formatAdminCurrency(e.expectedAmount, e.currency),
              'Provider Amt': formatAdminCurrency(e.providerAmount, e.currency),
              'Difference': formatAdminCurrency(e.difference, e.currency),
              'Owner': e.owner,
              'Detected': formatAdminDateTime(e.detectedAt),
            }),
            AppDimens.verticalMedium,
            ...
            AppDimens.verticalMedium,
            _info(context, 'Ledger Context', {'Detail': detail.ledgerContext}),
            if (detail.resolutionNotes.isNotEmpty) ...[
              AppDimens.verticalMedium,
              _info(context, 'Resolution', {'Notes': detail.resolutionNotes}),
            ],
            AppDimens.verticalMedium,
