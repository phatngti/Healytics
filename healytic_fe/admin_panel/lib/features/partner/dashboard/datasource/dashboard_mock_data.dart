...
final mockRecentReviews = [
  DashboardReview(
    ...
    text: 'Dịch vụ tuyệt vời! Nhân viên rất '
  ...
  DashboardReview(
    ...
    text: 'Không gian sạch sẽ, thoáng mát. '
  ...
  DashboardReview(
    ...
    text: 'Bác sĩ tư vấn rất kỹ và tận tâm. '
        'Sẽ quay lại lần sau.',
    status: 'published',
  ),
  DashboardReview(
    ...
    text: 'Dịch vụ tốt nhưng thời gian chờ '
        'hơi lâu.',
    status: 'published',
  ),
];
...
List<StaffScheduleEntry> getMockStaffSchedule(
  DateTime date,
) {
  return [
    StaffScheduleEntry(
...
final mockNotifications = [
  DashboardNotification(
    ...
    message: 'Nguyễn Văn An booked a '
  ...
  DashboardNotification(
    id: 'notif-002',
    title: 'New Review',
    message: 'Trần Thị Mai left a 4-star '
  ...
  DashboardNotification(
    ...
    message: 'Dr. Lê Hùng is on leave '
  ...
  DashboardNotification(
    ...
    message: 'Payment of 1,500,000₫ received '
        'from Hoàng Minh Đức.',
    type: 'system',
    createdAt: DateTime.now().subtract(
      const Duration(hours: 8),
  ...
  DashboardNotification(
    ...
    message: 'Essential oil supply is running '
...
final mockInventoryAlerts = [
  ...
  InventoryAlert(
    ...
    alertType: 'expiring',
    message: 'Batch expires in 5 days. '
        '12 units affected.',
    createdAt: DateTime.now().subtract(
  ...
  InventoryAlert(
    ...
    message: 'Out of stock since yesterday. '
