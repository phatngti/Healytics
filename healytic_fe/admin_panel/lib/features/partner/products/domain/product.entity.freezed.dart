...
mixin _$Product {
 ...
 String get name; String get description; DateTime? get createdAt; DateTime? get updatedAt; String get productType;// Pricing & Inventory
...
@useResult
$Res call({
 ProductId id, String name, String description, DateTime? createdAt, DateTime? updatedAt, String productType, double basePrice, double? salePrice, double? costPerItem, String? sku, String? barcode, int? stockQuantity, String status, bool onlineStore, CategoryEntity category, List<String> tags, int? duration, int? buffer, int? capacity, int? leadTime, String staffAllocation, List<String> staffIds, List<String> images, List<FacilityImageEntity> facilityImages, ServiceManualEntity? serviceManual
});


$CategoryEntityCopyWith<$Res> get category;$ServiceManualEntityCopyWith<$Res>? get serviceManual;
...
@override
@pragma('vm:prefer-inline')
$ServiceManualEntityCopyWith<$Res>? get serviceManual {
    if (_self.serviceManual == null) {
    return null;
  }

  return $ServiceManualEntityCopyWith<$Res>(_self.serviceManual!, (value) {
    return _then(_self.copyWith(serviceManual: value));
  });
}
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ProductId id,  String name,  String description,  DateTime? createdAt,  DateTime? updatedAt,  String productType,  double basePrice,  double? salePrice,  double? costPerItem,  String? sku,  String? barcode,  int? stockQuantity,  String status,  bool onlineStore,  CategoryEntity category,  List<String> tags,  int? duration,  int? buffer,  int? capacity,  int? leadTime,  String staffAllocation,  List<String> staffIds,  List<String> images,  List<FacilityImageEntity> facilityImages,  ServiceManualEntity? serviceManual)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Product() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.createdAt,_that.updatedAt,_that.productType,_that.basePrice,_that.salePrice,_that.costPerItem,_that.sku,_that.barcode,_that.stockQuantity,_that.status,_that.onlineStore,_that.category,_that.tags,_that.duration,_that.buffer,_that.capacity,_that.leadTime,_that.staffAllocation,_that.staffIds,_that.images,_that.facilityImages,_that.serviceManual);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ProductId id,  String name,  String description,  DateTime? createdAt,  DateTime? updatedAt,  String productType,  double basePrice,  double? salePrice,  double? costPerItem,  String? sku,  String? barcode,  int? stockQuantity,  String status,  bool onlineStore,  CategoryEntity category,  List<String> tags,  int? duration,  int? buffer,  int? capacity,  int? leadTime,  String staffAllocation,  List<String> staffIds,  List<String> images,  List<FacilityImageEntity> facilityImages,  ServiceManualEntity? serviceManual)  $default,) {final _that = this;
switch (_that) {
case _Product():
return $default(_that.id,_that.name,_that.description,_that.createdAt,_that.updatedAt,_that.productType,_that.basePrice,_that.salePrice,_that.costPerItem,_that.sku,_that.barcode,_that.stockQuantity,_that.status,_that.onlineStore,_that.category,_that.tags,_that.duration,_that.buffer,_that.capacity,_that.leadTime,_that.staffAllocation,_that.staffIds,_that.images,_that.facilityImages,_that.serviceManual);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ProductId id,  String name,  String description,  DateTime? createdAt,  DateTime? updatedAt,  String productType,  double basePrice,  double? salePrice,  double? costPerItem,  String? sku,  String? barcode,  int? stockQuantity,  String status,  bool onlineStore,  CategoryEntity category,  List<String> tags,  int? duration,  int? buffer,  int? capacity,  int? leadTime,  String staffAllocation,  List<String> staffIds,  List<String> images,  List<FacilityImageEntity> facilityImages,  ServiceManualEntity? serviceManual)?  $default,) {final _that = this;
switch (_that) {
case _Product() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.createdAt,_that.updatedAt,_that.productType,_that.basePrice,_that.salePrice,_that.costPerItem,_that.sku,_that.barcode,_that.stockQuantity,_that.status,_that.onlineStore,_that.category,_that.tags,_that.duration,_that.buffer,_that.capacity,_that.leadTime,_that.staffAllocation,_that.staffIds,_that.images,_that.facilityImages,_that.serviceManual);case _:
  return null;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,description,createdAt,updatedAt,productType,basePrice,salePrice,costPerItem,sku,barcode,stockQuantity,status,onlineStore,category,const DeepCollectionEquality().hash(_tags),duration,buffer,capacity,leadTime,staffAllocation,const DeepCollectionEquality().hash(_staffIds),const DeepCollectionEquality().hash(_images),const DeepCollectionEquality().hash(_facilityImages),serviceManual]);
...
@override $CategoryEntityCopyWith<$Res> get category;@override $ServiceManualEntityCopyWith<$Res>? get serviceManual;
...
/// Create a copy of Product
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? description = null,Object? createdAt = freezed,Object? updatedAt = freezed,Object? productType = null,Object? basePrice = null,Object? salePrice = freezed,Object? costPerItem = freezed,Object? sku = freezed,Object? barcode = freezed,Object? stockQuantity = freezed,Object? status = null,Object? onlineStore = null,Object? category = null,Object? tags = null,Object? duration = freezed,Object? buffer = freezed,Object? capacity = freezed,Object? leadTime = freezed,Object? staffAllocation = null,Object? staffIds = null,Object? images = null,Object? facilityImages = null,Object? serviceManual = freezed,}) {
