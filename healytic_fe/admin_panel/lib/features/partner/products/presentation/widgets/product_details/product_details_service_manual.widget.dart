...
class ProductDetailsServiceManualCard extends StatelessWidget {
  final Product product;

  const ProductDetailsServiceManualCard({super.key, required this.product});
      ...
      child: Column(
        ...
        children: [
          ...
          if (manual.serviceRules.isNotEmpty) ...[
            if (manual.preServiceGuidelines.isNotEmpty) _sectionDivider(),
            _buildRulesSection(context, theme, manual.serviceRules),
          ],
          if (manual.procedureSteps.isNotEmpty) ...[
            if (manual.preServiceGuidelines.isNotEmpty ||
                manual.serviceRules.isNotEmpty)
              _sectionDivider(),
            _buildStepsSection(context, theme, manual.procedureSteps),
          ],
        ],
      ),
    );
  ...
  Widget _buildGuidelinesSection(
    ...
    return Column(
      ...
      children: [
        ...
        ...guidelines.map((g) => _buildBulletPoint(theme, g)),
      ],
    );
  }
  ...
  Widget _buildRulesSection(
    ...
    return Column(
      ...
      children: [
        ...
        AppDimens.verticalSmall,
        ...rules.map((rule) => _buildRuleRow(theme, rule)),
      ],
    );
  }
  ...
  Widget _buildStepsSection(
    ...
    return Column(
      ...
      children: [
        ...
        AppDimens.verticalSmall,
        ...steps.map((step) => _buildStepRow(theme, step)),
      ],
    );
  }

  Widget _buildStepRow(ThemeData theme, ProcedureStepEntity step) {
    return Padding(
      padding: const EdgeInsets.only(bottom: 8),
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
