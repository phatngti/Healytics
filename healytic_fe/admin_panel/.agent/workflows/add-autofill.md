---
description: add ?autofill=true dev autofill to a named form screen
---

# /add-autofill — Add Dev Autofill to a Form
...
1. Read the `form-autofill` skill:
   `.agent/skills/form-autofill/SKILL.md`
