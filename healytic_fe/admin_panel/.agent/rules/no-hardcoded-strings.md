---
trigger: hardcoded_strings
description: "No hardcoded strings for form field keys, business/compare values, or API constants. Apply when writing or reviewing code that uses string literals for form fields, enum comparisons, JSON keys, or business logic values."
---
