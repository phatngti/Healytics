...
// tests for ProductResponseDto
void main() {
  // final instance = ProductResponseDto();

  group('test ProductResponseDto', () {
    ...
    test('to test the property `isVisibleOnline`', () async {
      // TODO
    });
    ...
    // List<ProductMediaDto> media (default value: const [])
    ...
    test('to test the property `serviceDefinition`', () async {
      // TODO
    });

    // Eligible employees for service
    // List<ServiceEmployeeEligibilityDto> serviceEmployeeEligibilities (default value: const [])
    test('to test the property `serviceEmployeeEligibilities`', () async {
      // TODO
    });
