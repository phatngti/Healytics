...
/// tests for AdminPartnersApi
void main() {
  // final instance = AdminPartnersApi();

  group('tests for AdminPartnersApi', () {
    ...
    test('test adminPartnersControllerGetPartnerDetail', () async {
      // TODO
    });
    ...
    test('test adminPartnersControllerReviewPartner', () async {
      // TODO
    });
