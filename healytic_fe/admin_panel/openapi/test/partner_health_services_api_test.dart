...
/// tests for PartnerHealthServicesApi
void main() {
  // final instance = PartnerHealthServicesApi();

  group('tests for PartnerHealthServicesApi', () {
    ...
    test('test partnerHealthServiceControllerCreate', () async {
      // TODO
    });
    ...
    test('test partnerHealthServiceControllerFindAll', () async {
      // TODO
    });
    ...
    test('test partnerHealthServiceControllerFindBySlug', () async {
      // TODO
    });
    ...
    //
    //Future partnerHealthServiceControllerRemove(String id) async
    test('test partnerHealthServiceControllerRemove', () async {
      // TODO
    });
    ...
    test('test partnerHealthServiceControllerUpdate', () async {
      // TODO
    });
