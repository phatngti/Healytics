...
// tests for PublicProductEmployeeResponseDto
void main() {
  // final instance = PublicProductEmployeeResponseDto();

  group('test PublicProductEmployeeResponseDto', () {
    // String id
    ...
    // bool isSelected
    test('to test the property `isSelected`', () async {
      // TODO
    });
    ...
    // List<PublicProductEmployeeDayScheduleDto> daySchedules (default value: const [])
