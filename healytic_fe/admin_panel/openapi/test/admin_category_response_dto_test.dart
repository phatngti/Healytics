...
// tests for AdminCategoryResponseDto
void main() {
  // final instance = AdminCategoryResponseDto();

  group('test AdminCategoryResponseDto', () {
    ...
    // Child categories
    // List<CategorySummaryDto> children (default value: const [])
