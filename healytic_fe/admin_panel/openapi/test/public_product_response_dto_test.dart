...
// tests for PublicProductResponseDto
void main() {
  // final instance = PublicProductResponseDto();

  group('test PublicProductResponseDto', () {
    ...
    // List<PublicProductMediaDto> media (default value: const [])
    ...
    // List<PublicProductEmployeeEligibilityDto> productEmployeeEligibilities (default value: const [])
