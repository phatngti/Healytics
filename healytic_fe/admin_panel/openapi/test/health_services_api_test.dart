...
/// tests for HealthServicesApi
void main() {
  // final instance = HealthServicesApi();

  group('tests for HealthServicesApi', () {
    // Get a service by id
    //
    //Future<PublicHealthServiceResponseDto> healthServiceControllerFindOne(String id) async
    test('test healthServiceControllerFindOne', () async {
      // TODO
    });
    ...
    test('test healthServiceControllerGetHomeRecommend', () async {
      // TODO
    });
    ...
    test('test healthServiceControllerGetPremiumTreatments', () async {
      // TODO
    });
    ...
    test('test healthServiceControllerGetProductEmployees', () async {
      // TODO
    });
    ...
    test('test healthServiceControllerGetProductInfo', () async {
      // TODO
    });
    ...
    test('test healthServiceControllerGetProductReviews', () async {
      // TODO
    });
    ...
    test('test healthServiceControllerGetRecommendedProducts', () async {
      // TODO
    });
