...
/// tests for EmployeeRevenueApi
void main() {
  // final instance = EmployeeRevenueApi();

  group('tests for EmployeeRevenueApi', () {
    ...
    test('test employeeRevenueControllerGetBreakdown', () async {
      // TODO
    });
    ...
    test('test employeeRevenueControllerGetSummary', () async {
      // TODO
    });
    ...
    test('test employeeRevenueControllerGetTrend', () async {
      // TODO
    });
