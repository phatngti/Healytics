# admin_openapi.api.TestBackdoorApi
...
------------- | ------------- | -------------
[**testBackdoorControllerCleanup**](TestBackdoorApi.md#testbackdoorcontrollercleanup) | **POST** /test-backdoor/cleanup | Delete only rows returned by a seed response
...
# **testBackdoorControllerCleanup**
> CleanupSeedDataResponseDto testBackdoorControllerCleanup(cleanupSeedDataDto)
...
try {
    ...
    print('Exception when calling TestBackdoorApi->testBackdoorControllerCleanup: $e\n');
}
```
...
[**CleanupSeedDataResponseDto**](CleanupSeedDataResponseDto.md)
