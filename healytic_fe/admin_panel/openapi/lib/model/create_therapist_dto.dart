...
class CreateTherapistDto {
  ...
  @override
  String toString() => 'CreateTherapistDto[authId=$authId, employeeCode=$employeeCode, fullName=$fullName, displayName=$displayName, email=$email, phone=$phone, avatarUrl=$avatarUrl, dob=$dob, gender=$gender, status=$status, branchId=$branchId, partnerId=$partnerId, profile=$profile]';
