...
class PublicHealthServiceEmployeeResponseDto {
  ...
  /// Returns a new [PublicHealthServiceEmployeeResponseDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PublicHealthServiceEmployeeResponseDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PublicHealthServiceEmployeeResponseDto[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PublicHealthServiceEmployeeResponseDto[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PublicHealthServiceEmployeeResponseDto> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PublicHealthServiceEmployeeResponseDto>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PublicHealthServiceEmployeeResponseDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PublicHealthServiceEmployeeResponseDto> mapFromJson(dynamic json) {
    final map = <String, PublicHealthServiceEmployeeResponseDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PublicHealthServiceEmployeeResponseDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PublicHealthServiceEmployeeResponseDto-objects as value to a dart map
  static Map<String, List<PublicHealthServiceEmployeeResponseDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PublicHealthServiceEmployeeResponseDto>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PublicHealthServiceEmployeeResponseDto.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
