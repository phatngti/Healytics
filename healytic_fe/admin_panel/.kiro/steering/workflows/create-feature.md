...
Scaffolds a complete new feature module following Clean Architecture with all layers, data sources, and providers.
...
4. **Create remote data source:** In `data/datasources/remote/<feature_name>_remote_datasource.dart`, create all three parts in ONE file:
   ...
   ```dart
   import 'package:admin_panel/features/<feature_name>/domain/entities/<feature_name>.entity.dart';
