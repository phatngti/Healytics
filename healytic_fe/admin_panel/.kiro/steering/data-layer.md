...
Use this guidance when working on data fetching, API calls, repository implementations, or anything in `data/` folders.
...
The generated client lives under `./openapi`. Map DTOs to domain entities in the data source implementation. Never expose DTOs to the domain or presentation layers.
