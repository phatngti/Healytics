...
description: GoRouter routing patterns for the Healytics app. Apply when adding screens, modifying navigation, or working with routes.
---
...
Tabs: Home (`/home`), Orders (`/orders`), Conversation History (`/conversation_history`), Notifications (`/notifications`), Profile (`/profile`).
