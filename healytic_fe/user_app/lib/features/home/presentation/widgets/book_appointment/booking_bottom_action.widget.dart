...
/// Sticky bottom "Continue" / "Confirm" action button
/// used across all booking flow steps.
///
/// Shows an elevated teal button when [canContinue]
/// is true, with a disabled state otherwise.
