...
mixin _$UserAccountEntity {
 ...
 String get id; String get email; String? get username; String? get firstName; String? get lastName; String? get phone; String? get dateOfBirth; bool get profileCompleted;
...
@override
int get hashCode => Object.hash(runtimeType,id,email,username,firstName,lastName,phone,dateOfBirth,profileCompleted);

@override
String toString() {
  return 'UserAccountEntity(id: $id, email: $email, username: $username, firstName: $firstName, lastName: $lastName, phone: $phone, dateOfBirth: $dateOfBirth, profileCompleted: $profileCompleted)';
}
...
@useResult
$Res call({
 String id, String email, String? username, String? firstName, String? lastName, String? phone, String? dateOfBirth, bool profileCompleted
});
...
/// Create a copy of UserAccountEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? email = null,Object? username = freezed,Object? firstName = freezed,Object? lastName = freezed,Object? phone = freezed,Object? dateOfBirth = freezed,Object? profileCompleted = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String email,  String? username,  String? firstName,  String? lastName,  String? phone,  String? dateOfBirth,  bool profileCompleted)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserAccountEntity() when $default != null:
return $default(_that.id,_that.email,_that.username,_that.firstName,_that.lastName,_that.phone,_that.dateOfBirth,_that.profileCompleted);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String email,  String? username,  String? firstName,  String? lastName,  String? phone,  String? dateOfBirth,  bool profileCompleted)  $default,) {final _that = this;
switch (_that) {
case _UserAccountEntity():
return $default(_that.id,_that.email,_that.username,_that.firstName,_that.lastName,_that.phone,_that.dateOfBirth,_that.profileCompleted);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String email,  String? username,  String? firstName,  String? lastName,  String? phone,  String? dateOfBirth,  bool profileCompleted)?  $default,) {final _that = this;
switch (_that) {
case _UserAccountEntity() when $default != null:
return $default(_that.id,_that.email,_that.username,_that.firstName,_that.lastName,_that.phone,_that.dateOfBirth,_that.profileCompleted);case _:
  return null;
...
class _UserAccountEntity extends UserAccountEntity {
  const _UserAccountEntity({required this.id, required this.email, this.username, this.firstName, this.lastName, this.phone, this.dateOfBirth, required this.profileCompleted}): super._();
...
/// Create a copy of UserAccountEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? email = null,Object? username = freezed,Object? firstName = freezed,Object? lastName = freezed,Object? phone = freezed,Object? dateOfBirth = freezed,Object? profileCompleted = null,}) {
