...
part 'chat_sse_event.entity.freezed.dart';
...
sealed class ChatSseEvent with _$ChatSseEvent {
  ...
  const factory ChatSseEvent({
    /// The kind of event received.
    required ChatSseEventType type,
  ...
  static ChatSseEventType? parseType(String raw) {
    return switch (raw) {
      ...
      'recommendation' =>
        ChatSseEventType.serviceRecommendation,
