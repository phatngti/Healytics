...
/// Mock conversation sessions for development and
/// testing.
final List<ChatConversation> kMockConversations = [
  ...
  ChatConversation(
    ...
    lastMessage:
        'Generated low impact cardio routine...',
  ...
  ChatConversation(
    ...
    lastMessage:
        'Configured daily alerts for vitamins...',
...
final List<ChatMessage> kMockMessages = [
  ChatMessage(
    id: '1',
    text:
        'Hello! 👋 I\'m your personal health '
        'assistant. I can help verify symptoms or '
        'guide you to the right specialist. How are '
        'you feeling today?',
  ...
  ChatMessage(
    id: '2',
    text:
        'Hi Dr. AI. I\'ve had a mild headache since '
        'this morning and I\'m feeling a bit dizzy.',
  ...
  ChatMessage(
    id: '3',
    text:
        'I\'m sorry to hear that. To help me '
        'understand better, on a scale of 1 to 10, '
        'how severe would you say the pain is '
        'right now?',
    timestamp: DateTime(2026, 2, 10, 9, 42),
  ),
];
