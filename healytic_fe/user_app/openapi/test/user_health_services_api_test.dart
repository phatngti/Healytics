...
/// tests for UserHealthServicesApi
void main() {
  // final instance = UserHealthServicesApi();

  group('tests for UserHealthServicesApi', () {
    // Get a service by ID
    //
    //Future<PublicHealthServiceResponseDto> userHealthServiceControllerFindOne(String id) async
    test('test userHealthServiceControllerFindOne', () async {
      // TODO
    });
    ...
    test('test userHealthServiceControllerGetEligibilityDetail', () async {
      // TODO
    });
    ...
    test('test userHealthServiceControllerGetHomeRecommend', () async {
      // TODO
    });
    ...
    test('test userHealthServiceControllerGetProductEmployees', () async {
      // TODO
    });
    ...
    test('test userHealthServiceControllerGetProductInfo', () async {
      // TODO
    });
    ...
    test('test userHealthServiceControllerGetProductReviews', () async {
      // TODO
    });
    ...
    test('test userHealthServiceControllerGetRecommendedProducts', () async {
      // TODO
    });
