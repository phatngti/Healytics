...
// tests for PublicHealthServiceEmployeeEligibilityDto
void main() {
  // final instance = PublicHealthServiceEmployeeEligibilityDto();

  group('test PublicHealthServiceEmployeeEligibilityDto', () {
    // Product ID
    // String productId
