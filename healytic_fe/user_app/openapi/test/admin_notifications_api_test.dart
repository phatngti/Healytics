...
/// tests for AdminNotificationsApi
void main() {
  // final instance = AdminNotificationsApi();

  group('tests for AdminNotificationsApi', () {
    ...
    test('test adminNotificationControllerCreateBroadcast', () async {
      // TODO
    });
    ...
    test('test adminNotificationControllerGetBroadcasts', () async {
      // TODO
    });
