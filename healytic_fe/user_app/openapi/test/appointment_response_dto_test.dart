...
// tests for AppointmentResponseDto
void main() {
  // final instance = AppointmentResponseDto();

  group('test AppointmentResponseDto', () {
    // String id
    ...
    // String checkInTime
    test('to test the property `checkInTime`', () async {
      // TODO
    });

    // String checkOutTime
    test('to test the property `checkOutTime`', () async {
      // TODO
    });
    ...
    // bool isReviewed
    test('to test the property `isReviewed`', () async {
      // TODO
    });
