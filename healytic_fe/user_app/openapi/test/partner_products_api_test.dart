...
/// tests for PartnerProductsApi
void main() {
  // final instance = PartnerProductsApi();
  ...
  group('tests for PartnerProductsApi', () {
    ...
    // Delete a product
    //
    //Future partnerProductsControllerRemove(String id) async
    test('test partnerProductsControllerRemove', () async {
      // TODO
    });
