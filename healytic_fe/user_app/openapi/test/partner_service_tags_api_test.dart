...
/// tests for PartnerServiceTagsApi
void main() {
  // final instance = PartnerServiceTagsApi();

  group('tests for PartnerServiceTagsApi', () {
    ...
    test('test serviceTagsControllerAttachToProduct', () async {
      // TODO
    });
    ...
    test('test serviceTagsControllerCreate', () async {
      // TODO
    });

    // Detach a tag from a product
    //
    //Future serviceTagsControllerDetachFromProduct(String id, String productId) async
    test('test serviceTagsControllerDetachFromProduct', () async {
      // TODO
    });
    ...
    test('test serviceTagsControllerFindActive', () async {
      // TODO
    });
    ...
    test('test serviceTagsControllerFindAll', () async {
      // TODO
    });
    ...
    test('test serviceTagsControllerFindOne', () async {
      // TODO
    });
    ...
    test('test serviceTagsControllerGetTagsForProduct', () async {
      // TODO
    });

    // Delete a service tag
    //
    //Future serviceTagsControllerRemove(String id) async
    test('test serviceTagsControllerRemove', () async {
      // TODO
    });
    ...
    test('test serviceTagsControllerUpdate', () async {
      // TODO
    });
