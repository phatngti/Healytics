...
// tests for PublicHealthServiceResponseDto
void main() {
  // final instance = PublicHealthServiceResponseDto();

  group('test PublicHealthServiceResponseDto', () {
    // Unique identifier
    // String id
    ...
    // Media assets
    // List<PublicHealthServiceMediaDto> media (default value: const [])
    ...
    // List<PublicHealthServiceEmployeeEligibilityDto> productEmployeeEligibilities (default value: const [])
