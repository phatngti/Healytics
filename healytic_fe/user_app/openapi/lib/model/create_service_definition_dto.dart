...
class CreateServiceDefinitionDto {
  ...
  @override
  String toString() => 'CreateServiceDefinitionDto[durationMinutes=$durationMinutes, bufferMinutes=$bufferMinutes, maxCapacity=$maxCapacity, minLeadTimeHours=$minLeadTimeHours, staffAssignmentType=$staffAssignmentType]';
