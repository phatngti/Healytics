...
class UpdatePartnerDto {
  ...
  int get hashCode =>
    ...
    (bussinessInfo == null ? 0 : bussinessInfo!.hashCode) +
    (legalRepresentative == null ? 0 : legalRepresentative!.hashCode) +
    (kycDocuments.hashCode);

  @override
  String toString() => 'UpdatePartnerDto[bussinessInfo=$bussinessInfo, legalRepresentative=$legalRepresentative, kycDocuments=$kycDocuments]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
    if (this.bussinessInfo != null) {
      json[r'bussinessInfo'] = this.bussinessInfo;
    } else {
      json[r'bussinessInfo'] = null;
    }
  ...
  static UpdatePartnerDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return UpdatePartnerDto(
        bussinessInfo: BusinessInfo.fromJson(json[r'bussinessInfo']),
        legalRepresentative: LegalRepresentativeDto.fromJson(json[r'legalRepresentative']),
        kycDocuments: KycDocumentDto.listFromJson(json[r'kycDocuments']),
      );
    }
    return null;
  }
