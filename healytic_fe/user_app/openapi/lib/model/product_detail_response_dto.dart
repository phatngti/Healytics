...
class ProductDetailResponseDto {
  /// Returns a new [ProductDetailResponseDto] instance.
  ...
  List<FeatureTagDto> featureTags;
  ...
  List<FacilityImageDto> facilityImages;

  List<ReviewDto> reviews;

  List<RecommendedServiceDto> recommendedServices;

  @override
  bool operator ==(Object other) => identical(this, other) || other is ProductDetailResponseDto &&
    other.id == id &&
    other.title == title &&
  ...
  /// Returns a new [ProductDetailResponseDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ProductDetailResponseDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ProductDetailResponseDto[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ProductDetailResponseDto[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return ProductDetailResponseDto(
        ...
        featureTags: FeatureTagDto.listFromJson(json[r'featureTags']),
        clinic: ClinicDto.fromJson(json[r'clinic'])!,
        specialists: SpecialistDto.listFromJson(json[r'specialists']),
        daySchedules: DayScheduleDto.listFromJson(json[r'daySchedules']),
        facilityImages: FacilityImageDto.listFromJson(json[r'facilityImages']),
        reviews: ReviewDto.listFromJson(json[r'reviews']),
        recommendedServices: RecommendedServiceDto.listFromJson(json[r'recommendedServices']),
      );
    }
    return null;
  }

  static List<ProductDetailResponseDto> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ProductDetailResponseDto>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ProductDetailResponseDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ProductDetailResponseDto> mapFromJson(dynamic json) {
    final map = <String, ProductDetailResponseDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ProductDetailResponseDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ProductDetailResponseDto-objects as value to a dart map
  static Map<String, List<ProductDetailResponseDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ProductDetailResponseDto>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ProductDetailResponseDto.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
