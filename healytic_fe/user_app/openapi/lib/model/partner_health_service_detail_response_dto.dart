...
class PartnerHealthServiceDetailResponseDto {
  /// Returns a new [PartnerHealthServiceDetailResponseDto] instance.
  ...
  /// Returns a new [PartnerHealthServiceDetailResponseDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PartnerHealthServiceDetailResponseDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PartnerHealthServiceDetailResponseDto[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PartnerHealthServiceDetailResponseDto[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return PartnerHealthServiceDetailResponseDto(
  ...
  static List<PartnerHealthServiceDetailResponseDto> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PartnerHealthServiceDetailResponseDto>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PartnerHealthServiceDetailResponseDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PartnerHealthServiceDetailResponseDto> mapFromJson(dynamic json) {
    final map = <String, PartnerHealthServiceDetailResponseDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PartnerHealthServiceDetailResponseDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PartnerHealthServiceDetailResponseDto-objects as value to a dart map
  static Map<String, List<PartnerHealthServiceDetailResponseDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PartnerHealthServiceDetailResponseDto>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PartnerHealthServiceDetailResponseDto.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
