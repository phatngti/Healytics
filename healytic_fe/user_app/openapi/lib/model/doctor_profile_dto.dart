...
class DoctorProfileDto {
  /// Returns a new [DoctorProfileDto] instance.
  DoctorProfileDto({
    this.title,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DoctorProfileDto &&
    other.title == title &&
  ...
  @override
  String toString() => 'DoctorProfileDto[title=$title, medicalLicense=$medicalLicense, experienceYears=$experienceYears, consultationFee=$consultationFee, specializations=$specializations, education=$education, certifications=$certifications]';
  ...
  /// Returns a new [DoctorProfileDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DoctorProfileDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "DoctorProfileDto[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "DoctorProfileDto[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DoctorProfileDto> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <DoctorProfileDto>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DoctorProfileDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DoctorProfileDto> mapFromJson(dynamic json) {
    final map = <String, DoctorProfileDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DoctorProfileDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of DoctorProfileDto-objects as value to a dart map
  static Map<String, List<DoctorProfileDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<DoctorProfileDto>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = DoctorProfileDto.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
