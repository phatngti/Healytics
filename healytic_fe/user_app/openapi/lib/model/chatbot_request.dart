...
class ChatbotRequest {
  ...
  ChatbotRequest({
    ...
    this.topK = 3,
    this.enableRecommendation = true,
    this.enableNer = true,
  });
  ...
  bool operator ==(Object other) => identical(this, other) || other is ChatbotRequest &&
    ...
    other.topK == topK &&
    other.enableRecommendation == enableRecommendation &&
    other.enableNer == enableNer;
  ...
  int get hashCode =>
    ...
    (message.hashCode) +
    (topK.hashCode) +
    (enableRecommendation.hashCode) +
    (enableNer.hashCode);

  @override
  String toString() => 'ChatbotRequest[conversationId=$conversationId, userId=$userId, message=$message, topK=$topK, enableRecommendation=$enableRecommendation, enableNer=$enableNer]';
  ...
  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      ...
      json[r'enable_recommendation'] = this.enableRecommendation;
      json[r'enable_ner'] = this.enableNer;
    return json;
  }
  ...
  static ChatbotRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ChatbotRequest(
        ...
        enableRecommendation: mapValueOfType<bool>(json, r'enable_recommendation') ?? true,
        enableNer: mapValueOfType<bool>(json, r'enable_ner') ?? true,
      );
    }
    return null;
  }
