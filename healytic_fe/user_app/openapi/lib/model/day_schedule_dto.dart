...
class DayScheduleDto {
  ...
  /// Time slots for this day (empty if not working)
  ...
  @override
  String toString() => 'DayScheduleDto[date=$date, dayOfWeek=$dayOfWeek, isWorkingDay=$isWorkingDay, slots=$slots]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'date'] = this.date;
      json[r'dayOfWeek'] = this.dayOfWeek;
      json[r'isWorkingDay'] = this.isWorkingDay;
  ...
  static DayScheduleDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return DayScheduleDto(
        ...
        dayOfWeek: mapValueOfType<String>(json, r'dayOfWeek')!,
        isWorkingDay: mapValueOfType<bool>(json, r'isWorkingDay')!,
