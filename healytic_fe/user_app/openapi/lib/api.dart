...
part 'model/business_type_dto.dart';
part 'model/business_types_response_dto.dart';
...
part 'model/document_update_dto.dart';
part 'model/document_verification_info_dto.dart';
...
part 'model/legal_representative_info_dto.dart';
part 'model/legal_representative_request_dto.dart';
part 'model/location_details_info_dto.dart';
...
part 'model/partner_info_dto.dart';
...
part 'model/update_legal_representative_dto.dart';
part 'model/update_partner_dto.dart';
part 'model/update_product_dto.dart';
part 'model/update_service_tag_dto.dart';
part 'model/verification_document_dto.dart';
part 'model/verification_optional_string_field_dto.dart';
part 'model/verification_string_field_dto.dart';
