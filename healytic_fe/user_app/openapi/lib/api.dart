...
part 'model/conversation_list_item_dto.dart';
part 'model/conversation_list_meta_dto.dart';
part 'model/conversation_list_response_dto.dart';
part 'model/create_category_dto.dart';
part 'model/create_doctor_dto.dart';
part 'model/create_doctor_profile_dto.dart';
part 'model/create_partner_product_definition_dto.dart';
part 'model/create_partner_product_dto.dart';
part 'model/create_partner_product_facility_image_dto.dart';
part 'model/create_partner_product_media_dto.dart';
part 'model/create_partner_product_review_dto.dart';
...
part 'model/partner_product_definition_dto.dart';
part 'model/partner_product_detail_response_dto.dart';
part 'model/partner_product_employee_eligibility_dto.dart';
part 'model/partner_product_media_dto.dart';
part 'model/partner_product_response_dto.dart';
...
part 'model/public_product_card_response_dto.dart';
part 'model/public_product_definition_dto.dart';
part 'model/public_product_employee_day_schedule_dto.dart';
part 'model/public_product_employee_eligibility_dto.dart';
part 'model/public_product_employee_response_dto.dart';
part 'model/public_product_info_response_dto.dart';
part 'model/public_product_media_dto.dart';
part 'model/public_product_recommended_response_dto.dart';
part 'model/public_product_response_dto.dart';
part 'model/public_product_review_response_dto.dart';
...
part 'model/update_partner_product_dto.dart';
