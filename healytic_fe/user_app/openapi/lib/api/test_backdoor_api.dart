...
class TestBackdoorApi {
  ...
  /// Parameters:
  ///
  /// * [CleanupSeedDataDto] cleanupSeedDataDto (required):
  Future<Response> testBackdoorControllerCleanupWithHttpInfo(CleanupSeedDataDto cleanupSeedDataDto,) async {
    // ignore: prefer_const_declarations
    final path = r'/test-backdoor/cleanup';

    // ignore: prefer_final_locals
    Object? postBody = cleanupSeedDataDto;
  ...
  Future<CleanupSeedDataResponseDto?> testBackdoorControllerCleanup(CleanupSeedDataDto cleanupSeedDataDto,) async {
    final response = await testBackdoorControllerCleanupWithHttpInfo(cleanupSeedDataDto,);
