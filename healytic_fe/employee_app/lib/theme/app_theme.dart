...
class AppTheme {
  ...
  /// Employee app uses a teal/professional scheme
  /// to differentiate from the user app's aqua blue.
  ...
  ThemeData darkTheme() {
    final base = FlexThemeData.dark(
      colors: FlexColor.schemes[FlexScheme.tealM3]!.light.defaultError.toDark(
        10,
        true,
      ),
