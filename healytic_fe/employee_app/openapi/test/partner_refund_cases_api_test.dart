...
/// tests for PartnerRefundCasesApi
void main() {
  // final instance = PartnerRefundCasesApi();

  group('tests for PartnerRefundCasesApi', () {
    ...
    test('test partnerRefundCasesControllerApprove', () async {
      // TODO
    });

    // List refund and dispute cases
    //
    //Future partnerRefundCasesControllerGetRefundCases({ String search, String startDate, String endDate, PartnerFinancePeriod period, PartnerCommerceSourceType sourceType, PartnerTransactionType transactionType, PartnerTransactionStatus transactionStatus, PartnerSettlementStatus settlementStatus, PartnerPayoutStatus payoutStatus, String currency, num page, num limit }) async
    test('test partnerRefundCasesControllerGetRefundCases', () async {
      // TODO
    });
    ...
    test('test partnerRefundCasesControllerReject', () async {
      // TODO
    });
