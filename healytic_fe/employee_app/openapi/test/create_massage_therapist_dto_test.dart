...
// tests for CreateMassageTherapistDto
void main() {
  // final instance = CreateMassageTherapistDto();

  group('test CreateMassageTherapistDto', () {
    // First name
    // String firstName
    ...
    test('to test the property `therapistLevel`', () async {
      // TODO
    });
