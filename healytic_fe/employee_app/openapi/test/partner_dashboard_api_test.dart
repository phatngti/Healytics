...
/// tests for PartnerDashboardApi
void main() {
  // final instance = PartnerDashboardApi();

  group('tests for PartnerDashboardApi', () {
    ...
    test('test partnerDashboardControllerGetEmployeeDistribution', () async {
      // TODO
    });
    ...
    test('test partnerDashboardControllerGetInventoryAlerts', () async {
      // TODO
    });
    ...
    test('test partnerDashboardControllerGetNotifications', () async {
      // TODO
    });
    ...
    test('test partnerDashboardControllerGetRecentReviews', () async {
      // TODO
    });
    ...
    test('test partnerDashboardControllerGetRevenue', () async {
      // TODO
    });
    ...
    test('test partnerDashboardControllerGetServicePerformance', () async {
      // TODO
    });
    ...
    test('test partnerDashboardControllerGetStaffSchedule', () async {
      // TODO
    });
    ...
    test('test partnerDashboardControllerGetStats', () async {
      // TODO
    });
    ...
    test('test partnerDashboardControllerGetUpcomingAppointments', () async {
      // TODO
    });
