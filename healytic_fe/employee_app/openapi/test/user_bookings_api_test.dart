...
/// tests for UserBookingsApi
void main() {
  // final instance = UserBookingsApi();

  group('tests for UserBookingsApi', () {
    ...
    test('test bookingControllerAsyncCheckout', () async {
      // TODO
    });
    ...
    test('test bookingControllerGetBooking', () async {
      // TODO
    });
    ...
    test('test bookingControllerGetTicketStatus', () async {
      // TODO
    });
    ...
    test('test bookingControllerListMyBookings', () async {
      // TODO
    });
