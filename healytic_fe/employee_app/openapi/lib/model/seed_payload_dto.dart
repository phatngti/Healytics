...
class SeedPayloadDto {
  ...
  @override
  String toString() => 'SeedPayloadDto[users=$users, categories=$categories, partners=$partners, employees=$employees, services=$services, coupons=$coupons, cartItems=$cartItems, bookings=$bookings]';
