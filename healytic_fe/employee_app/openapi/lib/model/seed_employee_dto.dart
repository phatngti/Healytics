...
class SeedEmployeeDto {
  ...
  @override
  String toString() => 'SeedEmployeeDto[key=$key, partnerKey=$partnerKey, partnerBrandName=$partnerBrandName, email=$email, employeeCode=$employeeCode, firstName=$firstName, lastName=$lastName, displayName=$displayName, phone=$phone, role=$role, status=$status, schedule=$schedule]';
