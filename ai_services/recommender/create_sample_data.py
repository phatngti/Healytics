...
sample_services = [
    ...
    },
    {
        ...
        "description": "Liệu trình massage trị liệu chuyên sâu cho người chấn thương thể thao, đau cơ mãn tính, hoặc sau phẫu thuật. Kỹ thuật massage y học kết hợp vật lý trị liệu, giúp giảm đau, tăng lưu thông máu và phục hồi chức năng vận động.",
        "category": "phuc_hoi",
        "tags": ["massage", "phục hồi chức năng", "chấn thương", "vật lý trị liệu", "giảm đau"],
        "type": "rehabilitation"
    },
    {
        "id": "SV010",
...
def create_sample_data():
    """Tạo file JSON chứa dữ liệu services mẫu"""
    os.makedirs(os.path.dirname(SERVICES_JSON_PATH), exist_ok=True)
    
    with open(SERVICES_JSON_PATH, 'w', encoding='utf-8') as f:
        json.dump(sample_services, f, ensure_ascii=False, indent=2)
    
    print(f"Đã tạo dữ liệu mẫu tại: {SERVICES_JSON_PATH}")
    print(f"Tổng số dịch vụ: {len(sample_services)}")
