...
\begin{itemize}
    ...
    \item \textbf{RAG Chatbot y tế đa ngôn ngữ chi phí thấp:} Triển khai self-hosted Llama-3.1-8B-Instruct + ChromaDB trên GPU A5000 đạt điểm trung bình 4.2/5 (Correctness 4.11, Helpfulness 4.20, Relevance 4.39) trên 498 mẫu, với chi phí chỉ \$0.00151/request --- bằng 1/8 chi phí gọi GPT-4 API cho cùng độ dài câu trả lời, mở ra phương án triển khai chatbot y tế phù hợp cho doanh nghiệp Việt Nam.
