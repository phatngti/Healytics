...
\begin{enumerate}
    ...
    \item \textbf{Mục tiêu cụ thể:}
        \begin{itemize}
            ...
            \item \textbf{Phát triển Chatbot AI:} Tích hợp chatbot có khả năng xử lý ngôn ngữ tự nhiên (NLP) để phân tích nhu cầu, triệu chứng ban đầu của người dùng và đưa ra gợi ý về các loại hình dịch vụ phù hợp nhất.
