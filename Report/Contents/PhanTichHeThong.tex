...
Sơ đồ minh họa quy trình đầy đủ từ đặt lịch hẹn, xác nhận, thanh toán qua Payment Gateway (MoMo, VNPay) đến đánh giá dịch vụ sau khi hoàn thành.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Images/sequences/fig_seq_booking_flow.png}
    \vspace{10pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Images/sequences/fig_seq_partner_register.png}
    \vspace{10pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Images/sequences/fig_seq_partner_verification.png}
    \vspace{10pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Images/sequences/fig_seq_booking_management_partner.png}
    \vspace{10pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Images/sequences/fig_seq_partner_service_management.png}
    \vspace{10pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Images/sequences/fig_seq_partner_staff_manager.png}
    \vspace{10pt}
