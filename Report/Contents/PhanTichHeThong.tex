...
\begin{itemize}
    \item \textbf{User App}: Phân hệ phục vụ người dùng cuối, cho phép người dùng đăng ký tài khoản, thực hiện khảo sát nhu cầu, tương tác với chatbot AI, nhận các gợi ý dịch vụ cá nhân hóa, đặt lịch hẹn và thực hiện thanh toán. Phân hệ này tập trung vào trải nghiệm người dùng và không xử lý các logic nghiệp vụ phức tạp.
    
    \item \textbf{Partner Portal}: Phân hệ dành cho các đối tác cung cấp dịch vụ như phòng khám, trung tâm thể thao, spa hoặc huấn luyện viên cá nhân. Đối tác sử dụng phân hệ này để quản lý thông tin dịch vụ, lịch làm việc của nhân viên, xác nhận lịch hẹn, theo dõi doanh thu và quản lý các chương trình khuyến mãi.
