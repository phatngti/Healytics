...
\begin{figure}[H]
    % Căn giữa hình ảnh
    \centering
    \includegraphics[width=0.7\textwidth]{Images/User_Usecase.jpg}
    \vspace{10pt}
...
\begin{figure}[H]
    % Căn giữa hình ảnh
    \centering
    \includegraphics[width=0.7\textwidth]{Images/Partner_Usecase.jpg}
    \vspace{10pt}
...
\begin{figure}[H]
    % Căn giữa hình ảnh
    \centering
    \includegraphics[width=0.7\textwidth]{Images/Admin_Usecase.jpg}
    \vspace{10pt}
...
\begin{figure}[H]
    ...
    \includegraphics[width=1\textwidth]{Images/Activity/4.5.1.png}
    \vspace{10pt}
...
\begin{figure}[H]
    % Căn giữa hình ảnh
    \centering
    \includegraphics[width=1\textwidth]{Images/Activity/4.5.2.png}
    \vspace{10pt}
...
\begin{figure}[H]
    ...
    \includegraphics[width=1\textwidth]{Images/Activity/4.5.4.png}
    \vspace{10pt}
...
\begin{figure}[H]
    % Căn giữa hình ảnh
    \centering
    \includegraphics[width=1\textwidth]{Images/Activity/4.5.3.png}
    \vspace{10pt}
...
\begin{figure}[H]
    % Căn giữa hình ảnh
    \centering
    \includegraphics[width=1\textwidth]{Images/Activity/4.5.5.png}
\vspace{10pt}
...
%     \centering
%     % Sử dụng width=1\textwidth để hình ảnh vừa với chiều rộng trang
%     \includegraphics[width=1\textwidth]{Images/Activity/4.5.6.png}
%     \vspace{10pt}
...
\begin{figure}[H]
    ...
    \centering
    % Sử dụng width=1\textwidth để hình ảnh vừa với chiều rộng trang
    \includegraphics[width=1\textwidth]{Images/Activity/4.5.7.png}
    \vspace{10pt}
...
\begin{figure}[H]
    ...
    \centering
    % Sử dụng width=1\textwidth để hình ảnh vừa với chiều rộng trang
    \includegraphics[width=1\textwidth]{Images/Activity/4.5.8.png}
    \vspace{10pt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Images/Activity/4.5.9.png}
    \vspace{10pt}
