...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Meta Llama 3.1 8B Instruct}: Mã nguồn mở chạy local cho RAG Chatbot, lượng tử hóa 4-bit (NF4) giảm VRAM ~24GB → ~8GB.
        \item \textbf{Google Gemini (2.5 Flash)}: API cho NER Service, xử lý tiếng Việt tốt, latency <1.5s, structured output (JSON).
    \end{itemize}
...
\begin{itemize}
    \item \textbf{Sentence Transformers}: \texttt{paraphrase-multilingual-mpnet-base-v2} cho embedding đa ngôn ngữ (tiếng Việt), 768 chiều.
    \item \textbf{ChromaDB}: Vector database mã nguồn mở, persistent storage, tích hợp LangChain.
    \item \textbf{FAISS}: Tìm kiếm vector hiệu năng cao cho offline evaluation, hỗ trợ IVF, HNSW.
\end{itemize}
...
Phân hệ Cổng Đối tác được xây dựng bằng Flutter Web, hỗ trợ nhà cung cấp quản lý toàn bộ vòng đời vận hành: từ đăng ký và xác minh hồ sơ KYC, hoàn thiện hồ sơ công khai phòng khám, quản trị dịch vụ, nhân sự và tài chính, đến giao tiếp với khách hàng và theo dõi chỉ số kinh doanh. Menu điều hướng gồm 6 mục: Dashboard, Services, Employee, Service Tags, Finance, Messages.
...
Luồng đăng ký đối tác diễn ra theo trình tự: (1)~đối tác điền form đăng ký trực tuyến; (2)~hệ thống chuyển hồ sơ sang trạng thái \texttt{PENDING} và gửi về Admin Portal để xét duyệt; (3)~nếu admin yêu cầu chỉnh sửa, đối tác nhận thông báo và cập nhật đúng các trường bị đánh dấu rồi nộp lại; (4)~sau khi được phê duyệt (\texttt{APPROVED}), đối tác hoàn thiện hồ sơ công khai phòng khám để mở khóa Dashboard.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/partner_register/fig_partner_register_1.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/partner_register/fig_partner_register_2.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/partner_register/fig_partner_register_3.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/partner_register/fig_partner_register_done.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/partner_register/fig_partner_revision_info.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/partner_register/fig_partner_revision_required_update_fields.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/partner_register/fig_partner_revision_updated_field.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/partner_register/fig_partner_complete_profile_1.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/partner_register/fig_partner_complete_profile_2.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/partner_register/fig_partner_complete_profile_3.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/dashboard/fig_partner_dashboard_1.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/dashboard/fig_partner_dashboard_2.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/dashboard/fig_partner_dashboard_3.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/dashboard/fig_partner_dashboar_4.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/service/fig_partner_service_dashboard_1.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/service/fig_partner_service_dashboard_2.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/service/fig_partner_service_dashboard_3.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/service/fig_partner_service_dashboard_4.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/service/fig_partner_service_dashboard_5.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/service/fig_partner_create_service_1.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/service/fig_parter_create_service_2.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/service/fig_partner_create_service_3.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/employee/fig_partner_employee_1.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/employee/fig_partner_employee_2.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/employee/fig_partner_employee_3.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/employee/fig_partner_create_employee_1.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/employee/fig_partner_create_employee_2_a.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/employee/fig_partner_create_employee_2_b.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/employee/fig_partner_create_employee_3.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/employee/fig_partner_create_employee_4.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/service_tag/fig_service_tags_dashboard.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/service_tag/fig_service_tags_create_new_service_tag.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/partner_finance/fig_partner_finance_1.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/partner_finance/fig_partner_finance_2.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/partner/message/fig_partner_user_message.png}
    \vspace{0.5em}
...
Admin Portal được xây dựng bằng Flutter Web, cung cấp cho quản trị viên công cụ giám sát và kiểm duyệt toàn bộ hệ thống với 5 module chính trên menu trái: Dashboard, Finance, Category, Provider, và Notifications. Mỗi module tương ứng với một nhóm nghiệp vụ quản trị độc lập.
...
Module Provider là trung tâm xét duyệt đối tác của Admin Portal. Luồng nghiệp vụ gồm 4 bước: (1)~quản trị viên xem hàng đợi hồ sơ chờ duyệt; (2)~mở chi tiết hồ sơ, xem thông tin kinh doanh, địa chỉ, KYC và tài liệu; (3)~đánh dấu từng trường hợp lệ/lỗi kèm Revision Note nếu cần; (4)~nhấn Approve, Request Revision hoặc Reject để hoàn tất xét duyệt.
\begin{itemize}
    \item (1)~quản trị viên xem hàng đợi hồ sơ chờ duyệt; 
    \item (2)~mở chi tiết hồ sơ, xem thông tin kinh doanh, địa chỉ, KYC và tài liệu; 
    \item (3)~đánh dấu từng trường hợp lệ/lỗi kèm Revision Note nếu cần; 
    \item (4)~nhấn Approve, Request Revision hoặc Reject để hoàn tất xét duyệt.
\end{itemize}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/admin/provider_management/fig_admin_provider_dashboard.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/admin/provider_management/fig_admin_provider_revisions.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/admin/provider_management/fig_admin_provider_request_revision_by_field.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/admin/dashboard/fig_admin_dashboard_1.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/admin/dashboard/fig_admin_dashboard_2.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/admin/dashboard/fig_admin_dashboard_3.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/admin/finance/fig_admin_finance_1.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/admin/finance/fig_admin_finance_2.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/admin/category/fig_admin_category_dashboard.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/admin/category/fig_admin_create_new_category.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/admin/notification_setting/fig_admin_notification_dashboard_1.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/admin/notification_setting/fig_admin_notification_dashboard_2.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/admin/notification_setting/fig_admin_notification_detail.png}
    \vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{Images/Hiện thực/admin/notification_setting/fig_admin_create_new_campain.png}
    \vspace{0.5em}
