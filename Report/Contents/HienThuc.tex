...
\begin{itemize}
    \item \textbf{KPI:} Doanh thu, số lịch hẹn, dịch vụ đang hoạt động và đánh giá trung bình theo kỳ (dữ liệu minh hoạ).
    ...
    \item \textbf{Employee Overview} (Tổng quan nhân viên): Biểu đồ vành khuyên (Donut Chart) phân bổ vai trò nhân sự.
\end{itemize}
