...
\paragraph{Advanced RAG (tìm kiếm lai trên OpenSearch)}

Đây là phương án nâng cấp dùng kho tri thức WHO trên OpenSearch. Khi người dùng đặt câu hỏi, hệ thống chạy song song hai nhánh: BM25 (từ khóa, thuật ngữ) và kNN (embedding). Hai danh sách kết quả được gộp bằng RRF (Reciprocal Rank Fusion), sau đó CrossEncoder reranker chọn ra các chunk liên quan nhất trước khi đưa vào LLM. Advanced RAG bổ sung khả năng bắt đúng thuật ngữ chuyên ngành và tên guideline WHO, trong khi nhánh embedding vẫn xử lý tốt câu hỏi diễn đạt tự nhiên.
