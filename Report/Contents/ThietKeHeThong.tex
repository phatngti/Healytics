...
\begin{itemize}
    ...
    \item \textbf{NER / PreFilter:} Dịch vụ tải cache địa điểm và danh mục từ cơ sở dữ liệu quan hệ khi khởi động; hỗ trợ truy vấn không gian (PostGIS) khi có ngữ cảnh khoảng cách hợp lệ.
\end{itemize}
% ============================================================
% THIẾT KẾ HỆ THỐNG
% ============================================================
