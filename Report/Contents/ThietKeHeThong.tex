...
Bảng~\ref{tab:arch-alt-comparison} đối chiếu kiến trúc N-tier với các mô hình thay thế thường gặp (CQRS, Microservices, Orchestration, MVP, Event-Driven) trên các tiêu chí then chốt.

\begin{table}[H]
    \centering
    \caption{So sánh Kiến trúc N-tier với các Kiến trúc khác}
    \label{tab:arch-alt-comparison}
    \vspace{0.3cm}
