...
\textbf{N-tier Architecture} tổ chức hệ thống thành các tầng độc lập, giao tiếp một chiều với tầng liền kề giúp giảm phụ thuộc chéo (Loose Coupling), tối ưu khả năng bảo trì, bảo mật và mở rộng. Hệ thống Healytics áp dụng kiến trúc 5 tầng; chi tiết công nghệ sẽ được trình bày sau sơ đồ tổng thể (Hình~\ref{fig:sys_arch}).
...
\begin{figure}[H]
    \centering
    \includegraphics[angle=-90, width=0.8\textwidth]{Images/ERD.png}
    \vspace{10pt}
...
Các giao diện thiết kế chi tiết được trình bày đầy đủ tại \textbf{Phụ lục C}.
