...
\textbf{N-tier Architecture} chia hệ thống thành các tầng độc lập theo trách nhiệm, giao tiếp theo luồng rõ ràng để tăng khả năng bảo trì, bảo mật và mở rộng.
\subsection{Kết cấu chi tiết 5 Tầng (Structure)}
\subsubsection{Tầng 1: Presentation Layer (Client Layer)}
Đây là tầng giao diện, tương tác trực tiếp với người dùng cuối.
\begin{itemize}
    \item \textbf{Chức năng:} Hiển thị dữ liệu và tiếp nhận thao tác người dùng.
    \item \textbf{Thành phần:} Ứng dụng mobile, web hoặc desktop.
\end{itemize}
\subsubsection{Tầng 2: Connection \& API Layer (Gateway)}
Đây là "người gác cổng" của hệ thống. Mọi yêu cầu từ Client đều đi qua tầng này trước khi vào nội bộ.
\begin{itemize}
...
Đây là "bộ não" của hệ thống, xử lý nghiệp vụ chính và thường được chia nhỏ thành \textbf{Microservices}.
\begin{itemize}
...
Tầng này quản lý và lưu trữ dữ liệu bền vững. Business Layer truy cập dữ liệu thông qua tầng này thay vì truy cập trực tiếp vào database vật lý.
\begin{itemize}
...
Đây là tầng kết nối dịch vụ bên ngoài để mở rộng chức năng mà không cần tự xây dựng lại từ đầu.
\begin{itemize}
    \item \textbf{Chức năng:}
    \begin{itemize}
