...
\usepackage{vntex}
%\usepackage[fontsize=12pt]{scrextend} % không cần, đã set 12pt trong documentclass
\usepackage{mathptmx}
...
\includepdf[pages=1,pagecommand={\thispagestyle{empty}}]{Bia.pdf}
\includepdf[pages={1,2,3,5}, pagecommand={\thispagestyle{empty}}]{PhieuChamDiem.pdf}
\setcounter{page}{2}
%\thispagestyle{empty}
\newpage
%%%%%%%%%%%%%%%%%INTRO%%%%%%%%%%%%%%%%%%%
