...
\begin{table}[h]
\begin{tabular}{rll}
\hspace{4 cm} &  \textbf{\Large HỘI ĐỒNG:} & {\Large Hội đồng 11L Khoa học Máy tính}
\\[0.3cm]
\hspace{4 cm} &   \textbf{\Large GVHD:} & {\Large TS. Trương Tuấn Anh}
\\[0.3cm]
\hspace{4 cm}  &    & {\Large CN. Dương Huỳnh Anh Đức}
\\[0.3cm]
\hspace{4 cm}  &   \textbf{\Large GVPB:} & {\Large 002890 - ThS. Trần Thị Quế Nguyệt}
\\[0.3cm]
% TKHĐ là THƯ KÝ HỘI ĐỒNG
\hspace{4 cm} &     \multicolumn{2}{l}{\textbf{$\;$ $\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$$\;$ \Large ---o0o---}} 
\\[0.3cm]
\hspace{4 cm} &   \textbf{\Large SVTH1:} & {\Large Lê Nguyễn Gia Hưng - 2211363}
\\[0.3cm]
\hspace{4 cm}&   \textbf{\Large SVTH2:}  & {\Large Nguyễn Tiến Phát - 1712572}
\\[0.3cm]
\hspace{4 cm} &   \textbf{\Large SVTH3:}  & {\Large Nguyễn Gia Nguyên - 2212303}
\end{tabular}
\end{table}
\vspace{0.5cm}
\begin{center}
